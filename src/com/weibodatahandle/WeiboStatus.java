...
public class WeiboStatus {
    ...
    private int is_thumb_pic_exsit = 0;
    //解析微博数据
    public void parser(String data){
        ...
        try {
            ...
            try{
                ...
                this.set_thumb_pic_exsit(1); 
            }catch (Exception e){
                this.set_thumb_pic_exsit(0); 
            }
            try{
    ...
    public void  set_thumb_pic_exsit(int isexsit)
    {
    	this.is_thumb_pic_exsit = isexsit;
    }
    public int  get_thumb_pic_exsit()
    {
    	return is_thumb_pic_exsit;
    }
}
